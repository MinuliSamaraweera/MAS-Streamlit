...
def update_defect_counts(worker_id, date_str, shift, run_off_d1, open_seam_d2, spi_errors_d3, high_low_d4, production_value):
    ...
    new_data = {
        ...
        'Shift': shift,
        'defect_count': defect_count,  # defect count
        'count': count  # non defects
    }
    ...
    try:
        ...
        st.success("Data successfully appended to defect_counts.csv")
...
def main():
    ...
    max_date = date.today()
    min_date = max_date - timedelta(days=1)  # Previous day
